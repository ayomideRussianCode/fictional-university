...
class MyNotes {
  ...
  events() {
    ...
    $("my-note").on("click", "edit-note", this.editNote.bind(this));
    $("#my-note").on("click", "update-note", this.updateNote.bind(this));
  ...
  makeNoteEditable(thisNote) {
    thisNote
      .find(".edit-note")
      .html('<i class="fa fa-times" aria-hidden="true"></i>Edit');
    thisNote
